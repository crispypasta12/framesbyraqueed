export const PHOTOS = [
  ...
  { id: 2,  title: 'Still Waters',     loc: 'Buriganga River', cam: 'XT-30ii', ar: '2/3',  g: 'linear-gradient(170deg,#0a1628 0%,#1a3a5c 55%,#2a5a7a 100%)' },
  ...
  { id: 6,  title: 'Bokeh Study',      loc: 'Gulshan',         cam: 'XT-30ii', ar: '4/3',  g: 'linear-gradient(120deg,#141428 0%,#2a1a4a 50%,#1a0d2e 100%)' },
  ...
  { id: 10, title: 'Dawn',             loc: "Cox's Bazar",     cam: 'XT-30ii', ar: '16/9', g: 'linear-gradient(180deg,#1a0a14 0%,#3a1a2a 40%,#5a2040 100%)' },
...
export const ALL_PHOTOS = [
  ...
  { id: 2,  title: 'Still Waters',      loc: 'Buriganga River',  cam: 'XT-30ii', ar: '2/3',  g: 'linear-gradient(170deg,#0a1628 0%,#1a3a5c 55%,#2a5a7a 100%)',  tags: ['Landscape', 'Water'] },
  ...
  { id: 6,  title: 'Bokeh Study',       loc: 'Gulshan',          cam: 'XT-30ii', ar: '4/3',  g: 'linear-gradient(120deg,#141428 0%,#2a1a4a 50%,#1a0d2e 100%)',  tags: ['Street', 'Night'] },
  ...
  { id: 10, title: 'Dawn',              loc: "Cox's Bazar",      cam: 'XT-30ii', ar: '16/9', g: 'linear-gradient(180deg,#1a0a14 0%,#3a1a2a 40%,#5a2040 100%)',  tags: ['Landscape', 'Golden Hour'] },
  ...
  { id: 13, title: 'Quiet Afternoon',   loc: 'Dhaka University', cam: 'XT-30ii', ar: '4/3',  g: 'linear-gradient(130deg,#0f1a10 0%,#253a20 50%,#1a2a18 100%)',  tags: ['Nature', 'Landscape'] },
  ...
  { id: 17, title: 'Monsoon Alley',     loc: 'Old Dhaka',        cam: 'XT-30ii', ar: '2/3',  g: 'linear-gradient(170deg,#080e14 0%,#0f1e2a 55%,#081420 100%)',  tags: ['Street', 'Nature'] },
  { id: 18, title: 'Morning Chai',      loc: 'Wari',             cam: 'X100VI',  ar: '1/1',  g: 'linear-gradient(140deg,#1a1208 0%,#3a2810 50%,#5a3c18 100%)',  tags: ['Street'] },
  { id: 19, title: 'Fog & Fields',      loc: 'Manikganj',        cam: 'XT-30ii', ar: '16/9', g: 'linear-gradient(180deg,#0a0f14 0%,#14202a 50%,#1a2a30 100%)',  tags: ['Landscape', 'Nature'] },
  ...
  { id: 23, title: 'Sylhet Green',      loc: 'Sylhet',           cam: 'XT-30ii', ar: '4/3',  g: 'linear-gradient(160deg,#061006 0%,#0f2010 50%,#1a3018 100%)',  tags: ['Nature', 'Landscape'] },
